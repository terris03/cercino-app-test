...
const EventDetails = () => {
  ...
  const releasedSection = () => {
    return (
      <div className={styles.releasedStyles}>
        <p className={styles.releasedTextStyles}>Released Vqt</p>
        <div className={styles.gapStylesOne}>
          <div className={styles.gapStylesTwo}>
            <p className={styles.priceTextStyles}>500</p>
            <p className={styles.soldTextStyles}>Sold</p>
          </div>
          <div className={styles.gapStylesTwo}>
            <div className={styles.gapStylesThree}>
              <p className={styles.numTextStyles}>23k</p>
              <p className={styles.revenueKrStyles}>Kr</p>
            </div>
            <p className={styles.revenueTextStyles}>Revenue</p>
          </div>
        </div>
      </div>
    );
